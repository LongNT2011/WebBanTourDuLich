              ...
              <div class="card p-3">
                  <form method="post" action="{{route('hotels.store')}}" enctype="multipart/form-data">
                      ...
                      <div class="form-group row border-bottom pb-4">
                          ...
                          <div class="col-sm-10">
                              <textarea class="form-control" name="rating" id="excerpt" cols="30" rows="5">{{ old('rating') }}</textarea>
                          </div>
                      </div>
                      <div class="form-group row border-bottom pb-4">
                      ...
                      <div class="form-group row border-bottom pb-4">
                          ...
                          <div class="col-sm-10">
                              <input type="text" class="form-control" name="pricePerPerson" id="description" cols="30" rows="7">{{ old('pricePerPerson') }}</input>
                          </div>
                      </div>
                      <div class="form-group row border-bottom pb-4">
